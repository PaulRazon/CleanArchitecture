...
namespace CleanArchitecture.Application.Features.Streamers.Commands.UpdateStreamer
{
    ...
    public class UpdateStreamerCommandHandler : IRequestHandler<UpdateStreamerCommand>
    {
        ...
        async public Task<Unit> Handle(UpdateStreamerCommand request, CancellationToken cancellationToken)
        {
            ...
            _logger.LogInformation($"La operacion fue exitosa actualizando el id {request.Id}");
